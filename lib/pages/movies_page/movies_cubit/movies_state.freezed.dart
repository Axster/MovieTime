...
abstract class $MoviesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<Movie> movies, bool isAscending, bool isLoading, bool hasError});
}
...
class _$MoviesStateImpl extends _MoviesState {
  ...
  @override
  String toString() {
    return 'MoviesState(movies: $movies, isAscending: $isAscending, isLoading: $isLoading, hasError: $hasError)';
  }
...
abstract class _MoviesState extends MoviesState {
  const factory _MoviesState(
      ...
      final bool isAscending,
      final bool isLoading,
      final bool hasError}) = _$MoviesStateImpl;
